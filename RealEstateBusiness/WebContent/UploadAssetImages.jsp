...
<div class="container col-sm-offset-4 col-sm-6">
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=1' method='post' enctype="multipart/form-data">
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=2' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=3' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=4' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=5' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
  ...
  <form class="form-horizontal" action='UploadAssetImages?image=submit' method='post' enctype="multipart/form-data">
