...
%>
	...
	<div class="container-fluid">
				...
				<div class="col-sm-4">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<a
								href="BargainCntr?page=AssetBidedPage&id=<%=a[i].getId()%>&asset=<%=a[i].getAssetname()%>&eprice=<%=a[i].getEprice()%>">
		...
		%>
			<br><br>
			<font color="red"><h3 align="center">
				<u>No-One Asset present here for Bargaining...</u>
			</h3></font><br> <br> <br>
		<%
