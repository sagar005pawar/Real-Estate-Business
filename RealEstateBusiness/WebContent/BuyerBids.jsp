...
<body>
	<%
		...
		ArrayList<Asset> a1 = (ArrayList<Asset>) httpSession.getAttribute("BuyerBids");
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
			<form action="BargainCntr?page=AuthorizingPage&id=<%=asset.getId()%>" method="post">
			...
			<%	for (int i = 0; i < a1.size(); i++) {  %>											
					<div class="row">
						...
						<div class="col-sm-6 well well-sm"><%=as1[i].getBprice() %></div>
					</div>
			<%} %>				

					<div class="col-sm-offset-6">
						<button type="button" class="btn btn-success" onclick='window.location.href="BargainCntr?page=BiderAssetsList"'><b>Back</b></button>						
					</div>
				</div>
				</form>
			</div>
