...
<html>
<head>
  <title>UploadVehicleImages</title>
...
<div class="container col-sm-offset-4 col-sm-6">
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=1' method='post' enctype="multipart/form-data">
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=2' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
      <label for="usname">Select Image-2 to upload:</label><br>
      <div  class="col-sm-4">
      <input type="file" name="assetImage" id="assetImage">      
      <!-- <input type="submit" value="Upload"> -->
      </div>
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=3' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
      <label for="usname">Select Image-3 to upload:</label><br>
      <div  class="col-sm-4">
      <input type="file" name="assetImage" id="assetImage">      
      <!-- <input type="submit" value="Upload"> -->
      </div>
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=4' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
      <label for="usname">Select Image-4 to upload:</label><br>
      <div  class="col-sm-4">
      <input type="file" name="assetImage" id="assetImage">      
      <!-- <input type="submit" value="Upload"> -->
      </div>
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=5' method='post' enctype="multipart/form-data">
  	<div class="form-group">   
      <label for="usname">Select Image-5 to upload:</label><br>
      <div  class="col-sm-4">
      <input type="file" name="assetImage" id="assetImage">      
      <!-- <input type="submit" value="Upload"> -->
      </div>
  ...
  <form class="form-horizontal" action='UploadVehicleImages?image=submit' method='post' enctype="multipart/form-data">
