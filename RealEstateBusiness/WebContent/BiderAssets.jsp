...
%>
	...
	<div class="container-fluid">
					...
					<div class="col-lg-12 col-md-8">
						...
						<div class="table-responsive">
							...
							<table class="table table-striped">
								...
								<tbody>																	
									<tr>				
										<td><a href="BargainCntr?page=BiderAssetsPage&asset=<%=a[i].getAssetname()%>"><%=a[i].getId()%></a></td>
										<td><%=a[i].getAssetname()%></td>
										<td><%=a[i].getCategory()%></td>
										<td><%=a[i].getEprice()%></td>
										<td><%=a[i].getInfo()%></td>
										<td>
					<form action="BargainCntr?page=BiderAssetsPage&asset=<%=a[i].getAssetname()%>" method="post">															
		...
		<br> <br> <font color="red"><h3 align="center">
				<u>You never bid on the front of the property...</u>
			</h3></font><br> <br> <br>
		<%
