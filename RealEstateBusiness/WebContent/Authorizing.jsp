		...
		<div class="row">
			...
			<form action="BargainCntr?page=AuthorizingPage&id=<%=asset.getId()%>" method="post">
				<div class="row col-sm-offset-1">
					...
					<%if("-".equals(asset.getBname())){ %>
						<%}else{ %>
							<button type="submit" class="btn btn-success"><b>Approve</b></button>
						<%} %>
						<button type="button" class="btn btn-success" onclick='window.location.href="BargainCntr?page=AuthorizerApprvingBid-price"'><b>Back</b></button>						
					</div>
					<% String msg=null;
