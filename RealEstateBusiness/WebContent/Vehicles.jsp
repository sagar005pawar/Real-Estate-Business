...
<%
	...
	ArrayList<Vehicle> vehicleArrayList = (ArrayList<Vehicle>) sess.getAttribute("vehicleArrayList");
	...
	<div class="container-fluid">
		<div class="row content">
			...
			<div class="col-sm-10">
				...
				<%
					vehicleArrayList.get(0).getId();
				for (int i = 0; i < vehicleArrayList.size(); i++) {
				%>
				<div class="col-sm-4">
					<div class="panel panel-primary">
						<div class="panel-heading"><%=vehicle[i].getVehicleName()%></div>
						<div class="panel-body">
							<a
								href="BargainCntr?page=VehiclesPage&vehicle=<%=vehicle[i].getVehicleName()%>"><img
								src='<%=vehicle[i].getImage1()%>' class='img-responsive'
								style='width: 300px; height: 200px'
								alt='<%=vehicle[i].getVehicleName()%>'></a>
						...
						<div class="panel-footer">
							<div class="row">
								...
								<div class="col-sm-6">
									<h4>
										$
										<%=vehicle[i].getEprice()%></h4>
								</div>
							</div>
							<a href="BargainCntr?page=VehiclesPage&vehicle=<%=vehicle[i].getVehicleName()%>"><%=vehicle[i].getCategory()%></a>
						</div>
					</div>
				</div>
				<%
