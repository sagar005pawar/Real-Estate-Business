...
<body>
	<%
	    ...
	    Vehicle vehicle=(Vehicle) httpSession.getAttribute("selectedVehicle");
	...
	<div class="container">
		<div class="row">
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel" >
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="<%=vehicle.getImage1() %>" alt="Image" style="width:700px; height: 450px">

							</div>

							<div class="item">
								<img src="<%=vehicle.getImage2() %>" alt="Image"
									style="width:700px; height: 450px">

							</div>

							<div class="item">
								<img src="<%=vehicle.getImage3() %>" alt="Image" style="width:700px; height: 450px">

							</div>

							<div class="item">
								<img src="<%=vehicle.getImage4() %>" alt="Image" style="width:700px; height: 450px">

							</div>
							<div class="item">
								<img src="<%=vehicle.getImage5() %>" alt="Image" style="width:700px; height: 450px">
			...
			<div class="col-sm-4">
			<form action="BargainCntr?page=VehicleBidingPage&id=<%=vehicle.getId()%>" method="post">
				<div class="row col-sm-offset-1">
					<div class="row" style="margin-bottom: 30px">
						<h1 align="center"><%=vehicle.getVehicleName() %></h1>
					</div>
					<div class="row">
						...
						<div class="col-sm-6 well well-sm"><%=vehicle.getEprice() %></div>
					...
					<div class="row">
						...
						<div class="col-sm-6 well well-sm"><%=vehicle.getBprice() %></div>
					</div>
					<%if(!user.getName().equals(vehicle.getSname())){ %>
					<div class="row">
						<div class="col-sm-6" align="right"
							style="margin-top: 8px; font-size: 16">
							<b>Your Bid Amount:</b>
						...
						<div class="col-sm-6 well well-sm">							
								<input type="number" min=<%=vehicle.getBprice() %> class="form-control" id="bidPrice" name="bidPrice" placeholder="Enter Bid" required="required">
						</div>
					</div>
					<%} %>
					<div class="col-sm-offset-6">
					<%if(!user.getName().equals(vehicle.getSname())){ %>
						<button type="submit" class="btn btn-success"><b>Bid Now</b></button>
					<%} %>
						<button type="button" class="btn btn-success" onclick='window.location.href="BargainCntr?page=Vehicles"'><b>Back</b></button>												
					</div>
				</div>
				</form>
			</div>
