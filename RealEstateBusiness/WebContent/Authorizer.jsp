...
<%
	...
	ArrayList<Asset> a1 = (ArrayList<Asset>) sess.getAttribute("Authority");
...
%>
	...
	<div class="container-fluid">
				...
				<div class="col-sm-4">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<a
								href="BargainCntr?page=AuthorizerPage&asset=<%=a[i].getId()%>"><img
		...
		<br> <br> <font color="red"><h3 align="center">
				<u>No-One Asset present here for Authorization...</u>
			</h3></font><br> <br> <br>
		<%
